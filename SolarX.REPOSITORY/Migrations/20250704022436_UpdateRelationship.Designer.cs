...
namespace SolarX.REPOSITORY.Migrations
{
    ...
    [Migration("20250704022436_UpdateRelationship")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SolarX.REPOSITORY.Entity.Agency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 7, 4, 9, 24, 34, 612, DateTimeKind.Unspecified).AddTicks(6903), new TimeSpan(0, 7, 0, 0, 0)),
                            ...
                            Slug = "Admin",
                            ThemeColor = "#000000",
                            UpdateAt = new DateTimeOffset(new DateTime(2025, 7, 4, 9, 24, 34, 612, DateTimeKind.Unspecified).AddTicks(6935), new TimeSpan(0, 7, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("SolarX.REPOSITORY.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 7, 4, 9, 24, 34, 612, DateTimeKind.Unspecified).AddTicks(7058), new TimeSpan(0, 7, 0, 0, 0)),
                            ...
                            Role = 0,
                            UpdateAt = new DateTimeOffset(new DateTime(2025, 7, 4, 9, 24, 34, 612, DateTimeKind.Unspecified).AddTicks(7059), new TimeSpan(0, 7, 0, 0, 0)),
            ...
            modelBuilder.Entity("SolarX.REPOSITORY.Entity.Inventory", b =>
                {
                    b.HasOne("SolarX.REPOSITORY.Entity.Agency", "Agency")
                        .WithOne("DefaultInventory")
                        .HasForeignKey("SolarX.REPOSITORY.Entity.Inventory", "AgencyId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("SolarX.REPOSITORY.Entity.InventoryTransaction", b =>
                {
                    ...
                    b.HasOne("SolarX.REPOSITORY.Entity.User", "CreatedBy")
                        .WithMany()
