...
namespace SolarX.REPOSITORY.Migrations
{
    ...
    [Migration("20250701070149_Initial")]
            ...
            modelBuilder.Entity("SolarX.REPOSITORY.Entity.Agency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 7, 1, 14, 1, 49, 31, DateTimeKind.Unspecified).AddTicks(8333), new TimeSpan(0, 7, 0, 0, 0)),
                            ...
                            Slug = "Admin",
                            ThemeColor = "#000000",
                            UpdateAt = new DateTimeOffset(new DateTime(2025, 7, 1, 14, 1, 49, 31, DateTimeKind.Unspecified).AddTicks(8364), new TimeSpan(0, 7, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("SolarX.REPOSITORY.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 7, 1, 14, 1, 49, 31, DateTimeKind.Unspecified).AddTicks(8477), new TimeSpan(0, 7, 0, 0, 0)),
                            ...
                            Role = 0,
                            UpdateAt = new DateTimeOffset(new DateTime(2025, 7, 1, 14, 1, 49, 31, DateTimeKind.Unspecified).AddTicks(8478), new TimeSpan(0, 7, 0, 0, 0)),
