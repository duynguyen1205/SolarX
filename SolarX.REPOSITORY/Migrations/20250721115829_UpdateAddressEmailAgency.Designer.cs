...
namespace SolarX.REPOSITORY.Migrations
{
    ...
    [Migration("20250721115829_UpdateAddressEmailAgency")]
    partial class UpdateAddressEmailAgency
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SolarX.REPOSITORY.Entity.Agency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 7, 21, 18, 58, 25, 429, DateTimeKind.Unspecified).AddTicks(4496), new TimeSpan(0, 7, 0, 0, 0)),
                            ...
                            Slug = "Admin",
                            ThemeColor = "#000000",
                            UpdateAt = new DateTimeOffset(new DateTime(2025, 7, 21, 18, 58, 25, 429, DateTimeKind.Unspecified).AddTicks(4530), new TimeSpan(0, 7, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("SolarX.REPOSITORY.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 7, 21, 18, 58, 25, 429, DateTimeKind.Unspecified).AddTicks(4684), new TimeSpan(0, 7, 0, 0, 0)),
                            ...
                            Role = 0,
                            UpdateAt = new DateTimeOffset(new DateTime(2025, 7, 21, 18, 58, 25, 429, DateTimeKind.Unspecified).AddTicks(4685), new TimeSpan(0, 7, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            AgencyId = new Guid("44444444-4444-4444-4444-444444444444"),
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 7, 21, 18, 58, 25, 429, DateTimeKind.Unspecified).AddTicks(4688), new TimeSpan(0, 7, 0, 0, 0)),
                            ...
                            Role = 1,
                            UpdateAt = new DateTimeOffset(new DateTime(2025, 7, 21, 18, 58, 25, 429, DateTimeKind.Unspecified).AddTicks(4689), new TimeSpan(0, 7, 0, 0, 0)),
