...
namespace SolarX.REPOSITORY.Migrations
{
    ...
    [Migration("20250722044442_AddSKUForProduct")]
    partial class AddSKUForProduct
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SolarX.REPOSITORY.Entity.Agency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 7, 22, 11, 44, 40, 421, DateTimeKind.Unspecified).AddTicks(1260), new TimeSpan(0, 7, 0, 0, 0)),
                            ...
                            Slug = "Admin",
                            ThemeColor = "#000000",
                            UpdateAt = new DateTimeOffset(new DateTime(2025, 7, 22, 11, 44, 40, 421, DateTimeKind.Unspecified).AddTicks(1289), new TimeSpan(0, 7, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("SolarX.REPOSITORY.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 7, 22, 11, 44, 40, 421, DateTimeKind.Unspecified).AddTicks(1408), new TimeSpan(0, 7, 0, 0, 0)),
                            ...
                            Role = 0,
                            UpdateAt = new DateTimeOffset(new DateTime(2025, 7, 22, 11, 44, 40, 421, DateTimeKind.Unspecified).AddTicks(1409), new TimeSpan(0, 7, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            AgencyId = new Guid("44444444-4444-4444-4444-444444444444"),
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 7, 22, 11, 44, 40, 421, DateTimeKind.Unspecified).AddTicks(1413), new TimeSpan(0, 7, 0, 0, 0)),
                            ...
                            Role = 1,
                            UpdateAt = new DateTimeOffset(new DateTime(2025, 7, 22, 11, 44, 40, 421, DateTimeKind.Unspecified).AddTicks(1413), new TimeSpan(0, 7, 0, 0, 0)),
