...
namespace SolarX.REPOSITORY.Migrations
{
    ...
    [Migration("20250725121714_UpdateFormConsulting")]
    partial class UpdateFormConsulting
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SolarX.REPOSITORY.Entity.Agency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 7, 25, 19, 17, 12, 427, DateTimeKind.Unspecified).AddTicks(2835), new TimeSpan(0, 7, 0, 0, 0)),
                            ...
                            Slug = "Admin",
                            ThemeColor = "#000000",
                            UpdateAt = new DateTimeOffset(new DateTime(2025, 7, 25, 19, 17, 12, 427, DateTimeKind.Unspecified).AddTicks(2871), new TimeSpan(0, 7, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("SolarX.REPOSITORY.Entity.ConsultingRequest", b =>
                {
                    ...
                    b.Property<double>("AverageUsageLast3Months")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("SolarX.REPOSITORY.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 7, 25, 19, 17, 12, 427, DateTimeKind.Unspecified).AddTicks(3011), new TimeSpan(0, 7, 0, 0, 0)),
                            ...
                            Role = 0,
                            UpdateAt = new DateTimeOffset(new DateTime(2025, 7, 25, 19, 17, 12, 427, DateTimeKind.Unspecified).AddTicks(3012), new TimeSpan(0, 7, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            AgencyId = new Guid("44444444-4444-4444-4444-444444444444"),
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 7, 25, 19, 17, 12, 427, DateTimeKind.Unspecified).AddTicks(3016), new TimeSpan(0, 7, 0, 0, 0)),
                            ...
                            Role = 1,
                            UpdateAt = new DateTimeOffset(new DateTime(2025, 7, 25, 19, 17, 12, 427, DateTimeKind.Unspecified).AddTicks(3016), new TimeSpan(0, 7, 0, 0, 0)),
